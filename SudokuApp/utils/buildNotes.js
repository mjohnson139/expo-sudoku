...
const BUILD_NOTES = {
  '3.3.0': {
    ...
    notes: [
      ...
      'A three-face case preview updates live while you turn, and Save keeps the starting cube, moves, name and stages together',
      'Before writing the algorithm, turn the solved cube into its starting case and choose Use this start',
      'Tap the small 3D case preview whenever you want to put that starting case back on the large cube',
  ...
  '3.2.0': {
    ...
    notes: [
      ...
      'The method rides on the solve\'s card, so a list of attempts says what each one was',
