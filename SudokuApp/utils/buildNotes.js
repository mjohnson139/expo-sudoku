...
const BUILD_NOTES = {
  ...
  '3.2.0': {
    ...
    notes: [
      ...
      'Your best time is kept between visits, and you can put your name on it',
      'Beat it and the board says NEW RECORD, counts your moves and your time up, and asks for a name',
      ...
      'Solving buzzes, and a new record buzzes differently',
