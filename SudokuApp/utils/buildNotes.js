...
const BUILD_NOTES = {
  '3.1.0': {
    ...
    notes: [
      ...
      'Write a solve: tap Solve and a move pad opens, with the cube starting from the scramble',
      ...
      'A solve is a scratchpad for now — it is not kept when you leave, and a new scramble clears it',
