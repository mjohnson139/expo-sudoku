...
const BUILD_NOTES = {
  '3.1.0': {
    ...
    notes: [
      ...
      'Hold a key for a prime — R held is R’ — with a line filling across the key so you can see it coming',
      'Let go early, or slide your finger off the key, and nothing is written',
      ...
      'A tick under the cube for every move, split into the groups you named, so you can see the shape of a solve at a glance',
