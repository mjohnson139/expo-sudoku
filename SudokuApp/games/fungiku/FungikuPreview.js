 ...
 * conflict handling. Step 3 (this one) made it the body of Fungiku's own screen
 * off the hub; Step 4 makes it playable and Step 5 supersedes it with the real
 * board component. Until then it is scaffolding for looking at engine output.
 */

const SIZES = [5, 6, 7, 8];
const BOARD_MAX = 320;

const FungikuPreview = ({ theme }) => {
  ...
  return (
    <View style={[styles.sheet, { backgroundColor: surface, borderColor: border }]}>
      <Text style={[styles.title, { color: titleColor }]}>Engine preview</Text>
